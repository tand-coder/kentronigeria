            ...
            <div class="container">
                  ...
                  <div class="col-lg-12">
                     ...
                     <form id='contact-form' class="contact-form" name="customerData" action="mail-pvt.php" method="post" onSubmit="javascript: return enquiryvalid(this);">
                        ...
                        <div class="row">
                           ...
                           <div class="col-lg-12">
                              <div class="form-group">
                                 <input class="form-control form-website" id="number" name="number" pattern="^[0-9-+\s()]*$" minlength="10" maxlength="10" title="10 digit mobile number" value="" placeholder="Phone" type="tel" required="">
                              </div>
                           </div>
                           <div class="col-lg-12">
                              <div class="form-group">
               ...
               <!-- <div class="col-md-8">
                  <div class="banner-heading">
                     <h1 class="banner-title">PUBLIC LIMITED COMPANY REGISTRATION</h1>
                     <ol class="breadcrumb">
                        <li><a href="#">Home</a></li>
                        <li>services</li>
                     </ol>
